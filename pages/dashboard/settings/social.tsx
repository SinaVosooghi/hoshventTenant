import { Button, Col, Form, Row, Select, Input, notification } from "antd";
  ...
  return (
    ...
    >
      <Row gutter={[16, 16]}>
        ...
        <Col md={12} xs={24}>
          <Form.Item label="تویتر" name="twitter">
            <Input placeholder="https://twitter.com/**********" />
          </Form.Item>
        </Col>
        <Col md={12} xs={24}>
          <Form.Item label="اینتساگرم" name="instagram">
            <Input placeholder="https://instagram.com/******" />
          </Form.Item>
        </Col>
        <Col md={12} xs={24}>
          <Form.Item label="لینکداین" name="linkedin">
