...
import SeminarItem from "../../src/components/plans/SeminarItem";
require("./style.less");
...
const Courses = () => {
  ...
  const [getItems, { data: seminarsApi, loading }] = useLazyQuery(
    siteGetSminarsApi,
    {
  ...
  return (
    <>
      <NextSeo title={"سمینار ها"} description={"آخرین سمینار ها "} />
      <MainBreadCrumb activeItem="سمینار ها" />
      <div id="events">
        <Row justify="center">
          <Col md={20} xs={24}>
            <Fade>
        ...
        <Fade>
          <Row justify="center" id="events-container" gutter={[30, 30]}>
            ...
            <Col md={15} xs={24} className="top-order">
              <List
                loading={loading}
                dataSource={seminarsApi?.seminarsApi?.seminars}
                grid={{
                  // @ts-ignore
                  gutter: [30, 55],
                  xs: 1,
